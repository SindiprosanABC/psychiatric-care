          ...
          <div className="flex flex-col items-center md:flex-row">
            <div className="mb-8 w-full md:mb-0 md:w-1/3">
              <h2 className="mb-2 text-2xl font-bold text-[#6b2b2c]">
                Uma abordagem personalizada com excelência clínica.
              </h2>
              <p className="text-gray-600">
                Atendimento especializado, adaptado às suas necessidades e
            ...
            <div className="grid w-full grid-cols-1 gap-6 sm:grid-cols-3 md:w-2/3">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="mb-1 font-semibold">Avaliação Psiquiátrica</h3>
                <p className="text-sm text-gray-500">
                  Avaliação abrangente para um diagnóstico preciso
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#ffe4cf]">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="mb-1 font-semibold">Consultas Online</h3>
                <p className="text-sm text-gray-500">
                  Atendimento prático no conforto de casa
                </p>
              </div>
            </div>
          </div>
